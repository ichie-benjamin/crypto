...
@section('content')
    ...
    <div class="bg-fix mt-3" >

        <!-- Page content -->
        <div class="no-padding content-area no-sidebar mt-3" role="main">
            <div class="container-fluid">
                <div class="row entry-content">
                    <!-- Section1 - Cryptic About Us -->
                    <div class="clearfix"></div>
                    <div class="cryptic_about_us padding_80 data_background text-center" style="margin-top: 60px">
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="title-subtile-holder wow ">
                                        <h1 class="section-title text-white">CONTACT US</h1>
                                        <div class="section-subtitle text-white">Have a question or inquiry to make<br /> Contact Binary 24 Trade.
                                        </div>
                                    </div>
                                    ...
                                    <div role="form" lang="en-US" dir="ltr">
                                        ...
                                        <form id="contact_form"  action="#"  class="wpcf7-form" >
                                            <div class="-contact">
                                                <input type="text" name="user_name" class="col-md-6" value="" size="40" aria-required="true" aria-invalid="false" placeholder="First Name" />
                                                <br />
                                                <input type="text"  name="user_last_name" class="col-md-6" value="" size="40" aria-required="true" aria-invalid="false" placeholder="Last Name" />
                                                <br />
