            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="banner_text text-center">
                        <h1 class="animation" data-animation="fadeInUp" data-animation-delay="1.1s">Privacy and Policy</h1>
                        <ul class="breadcrumb bg-transparent justify-content-center animation m-0 p-0" data-animation="fadeInUp" data-animation-delay="1.3s">
                            ...
                            <li><span><a href="{{ route('privacy') }}">PRIVACY</a></span></li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-12 offset-lg-2">
                    <div class="title_default_dark title_border text-center">
                        <h4 class="animation" data-animation="fadeInUp" data-animation-delay="0.2s">Privacy and Policy</h4>
                    </div>
                </div>
            </div>
            <div class="row small_space">
                <div class="col-lg-10 col-md-12 offset-lg-1">
                    ...
                    <br><br>
                    1. WHO WE ARE
                    Binary 24 Trades, is a company registered in  London, United Kingdom and having its registered address at Binary Solution is a product of Investment  Solutions Limited incorporated in Mauritius (hereinafter Binary 24 Trades). Binary 24 Trades is the controller and responsible for the data of its Client disclosed to it in order to register for a Trading Account, Demo Account and/or to make use of any other services offered by the Binary 24 Trades Group (as defined in Appendix A) through the website (hereinafter “Website”) (this term shall at all times include Website’s desktop and mobile versions). Binary 24 Trades exercises control over the processing of data in undertakings affiliated to it and which belong to the Binary 24 Trades Group of companies.
                    <br><br>
                    This Privacy Policy addresses the privacy issues of the Binary 24 Trades Group so when we mention “Binary 24 Trades”, “Company”, “we”, “us” or “our” in this Privacy Policy, we are referring to the relevant company in the Binary 24 Trades group responsible for collecting and/or processing your data when you use the Trading Platform through the Website, either for a Trading Account or a Demo Account (or their mobile/desktop versions) (hereinafter the Service(s)). In Binary 24 Trades we respect your privacy and therefore all companies within the Binary 24 Trades group are committed to protect your data, which it collects, uses and/or has access to.
                    <br><br>
                    ...
                    <br><br>
                    The Company shall not divulge any private information of its Clients and former Clients unless the Client approves in writing such disclosure or unless such disclosure is required under applicable law or is required in order to verify the Client's identity or it is required for Binary 24 Trades to perform its contractual obligations under any agreement concluded with the Client. The Clients' information is processed only by the employees of the Company and/or employees of the Binary 24 Trades group and/or trusted third parties which provide specific support services, dealing with the specific Client's Accounts and necessary for the provision of our services. All such information shall be stored on electronic and physical storage media according to applicable law.
                    <br><br>
                    2. DATA USAGE
                    ...
                    Notwithstanding the above, if Binary 24 Trades combines Aggregate Data with data in a way that the end result can in any way identify the data subject, Binary 24 Trades shall treat such combined data as data which will be treated as per the provisions herein contained.
                    <br><br>
                    Processing of your data is carried out by Binary 24 Trades following the principles of lawfulness, fairness, transparency, and always adhering to the intended purpose of data processing, the principle of data minimization, accuracy, limited data storage, data integrity, confidentiality and accountability.
                    <br><br>
                    In general Binary 24 Trades collects and process the Personal Data, for any of the following reasons:
                    <br><br>
                    ...
                    The Client acknowledges that all or part of the data concerning the Client's account and related transactions will be stored by the Binary 24 Trades and may be used by the Company in case of dispute between the Client and the Company.
                    <br><br>
