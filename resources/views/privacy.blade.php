        ...
        <div class="container">
            ...
            <div class="row small_space">
                <div class="col-lg-10 col-md-12 offset-lg-1">
                    ...
                    <br><br>
                    The Company shall not divulge any private information of its Clients and former Clients unless the Client approves in writing such disclosure or unless such disclosure is required under applicable law or is required in order to verify the Client's identity or it is required for Crypto Assets to perform its contractual obligations under any agreement concluded with the Client. The Clients' information is processed only by the employees of the Company and/or employees of the Crypto Assets group and/or trusted third parties which provide specific support services, dealing with the specific Client's Accounts and necessary for the provision of our services. All such information shall be stored on electronic and physical storage media according to applicable law.
                    <br><br>
                    2. DATA USAGE
                    ...
                    Notwithstanding the above, if Crypto Assets combines Aggregate Data with data in a way that the end result can in any way identify the data subject, Crypto Assets shall treat such combined data as data which will be treated as per the provisions herein contained.
                    <br><br>
                    Processing of your data is carried out by Crypto Assets following the principles of lawfulness, fairness, transparency, and always adhering to the intended purpose of data processing, the principle of data minimization, accuracy, limited data storage, data integrity, confidentiality and accountability.
                    <br><br>
                    In general Crypto Assets collects and process the Personal Data, for any of the following reasons:
                    <br><br>
