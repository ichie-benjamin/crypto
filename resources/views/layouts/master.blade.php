    ...
    <div class="fixed-sidebar-menu">
        ...
        <div class="header7 sidebar-content">
            ...
            <div class="left-side">
                <h1 class="logo">
                    <a href="index-2.html">
                        <img src="assets/images/logo_black.png" alt="Cryptic" />
                    </a>
                </h1>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="navbar-header col-md-2">
                        ...
                        <h1 class="logo">
                            <a href="{{ route('home') }}">
                                <img src="assets/images/logo_trading.png" alt="Binary24Trades" />
                            </a>
                        </h1>
                    </div>
                    ...
                    <div id="navbar" class="navbar-collapse collapse col-md-7">
                        <ul class="menu nav navbar-nav pull-left nav-effect nav-menu">
                            <li class="homepages-badge menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item current_page_item current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children"><a href="index-2.html">Home</a>
                                <ul class="sub-menu">
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item current_page_item"><a href="index-2.html">Main Home</a></li>
            ...
            <div class="container-fluid footer">
                <div class="col-md-12">
                    <p class="copyright text-center">
                        <a href="#">Cryptocurrency  Template</a> by ModelTheme. 2018 All Rights Reserved.
                    </p>
                </div>
            </div>
        </div>
